        ...
        <div className="flex md:flex-row flex-col justify-between items-center mt-32">
            <div
                ...
                <div className="flex flex-col md:px-0 sm:px-12 px-9 md:items-start items-center">
                    <h1 className="text-white xl:text-7xl lg:text-5xl md:text-4xl text-3xl font-extrabold md:text-start text-center mb-2 pt-4">
                        <span
                            className="text-transparent bg-clip-text bg-gradient-to-r from-[#FB8D1E] via-[#91F4FE] to-white">
                            Bonjour, Je suis
                        </span>
                    </h1>
                    <span className="text-white xl:text-7xl lg:text-5xl md:text-4xl text-3xl font-extrabold md:text-start text-center lg:mb-8 md:mb-6 mb-4">
                        <TypeAnimation
                            sequence={[
                                "Samuel",
                                1000,
                    ...
                    <p className="text-[#929292] text-center md:text-start xl:text-xl lg:text-base md:text-xs text-xs lg:mb-7 md:mb-5 mb-6 font-bold">
                        Étudiant en deuxième année chez SUPINFO Caen. Passionné d'informatique, je suis ouvert à toute
                        opportunité de stage ou d'alternance pour mes études.
                    </p>
                </div>
                <div className="flex md:flex-row flex-col md:items-start items-center">
                    ...
                    <button
                        ...
                        <span className="block bg-[#1F1F1F] hover:bg-neutral-800 rounded-full px-7 py-2">Mon CV</span>
                    </button>
                </div>
            </div>
            <div className="flex md:mt-0 header bg-gradient-to-br from-[#FB8D1E] to-[#91F4FE] xl:h-[450px] lg:h-[350px] md:h-[250px] md:w-1/2 w-full items-center justify-center">
